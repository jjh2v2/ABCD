...
public class tk2dTileMapDemoPlayer : MonoBehaviour {
	...
	void Awake() {
		...
		if (Application.platform == RuntimePlatform.WindowsEditor || Application.platform == RuntimePlatform.WindowsPlayer || Application.platform == RuntimePlatform.WebGLPlayer || /*Application.platform == RuntimePlatform.WindowsWebPlayer ||*/
