...
{
    public GameObject OverPanelDefultBtn;
    public GameObject OverPanelRewardBtn;
...
#if UNITY_ANDROID
        string appId = "ca-app-pub-5776498612248580~3169374114";
#elif UNITY_IPHONE
        string appId = "ca-app-pub-5776498612248580~7137497144";
#else
    ...
    public void OnGUI()
    {
        ...
        //Rect rect = new Rect(0, -600, Screen.width, Screen.height);
...
#if UNITY_EDITOR
        string adUnitId = "ca-app-pub-5776498612248580/3345877208";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-5776498612248580/3345877208";
#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-5776498612248580/6901978831";
#else
    ...
    public void RequestInterstitial()
    {
        // These ad units are configured to always serve test ads.
#if UNITY_EDITOR
        string adUnitId = "ca-app-pub-5776498612248580/6590702230";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-5776498612248580/6590702230";
#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-5776498612248580/3090440925";
#else
        string adUnitId = "unexpected_platform";
#endif
    ...
    {
#if UNITY_EDITOR
        string adUnitId = "ca-app-pub-5776498612248580/1146803866";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-5776498612248580/1146803866";
#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-5776498612248580/8319002283";
#else
        string adUnitId = "unexpected_platform";
#endif
    ...
    public void HandleRewardBasedVideoClosed(object sender, EventArgs args)
    {
        ...
        OverPanelDefultBtn.SetActive(true);
        if (mReward)
        {
            OverPanelRewardBtn.SetActive(false);
        }
        else
        {
            OverPanelRewardBtn.SetActive(true);
        }
    }
